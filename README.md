...
| Configuration Option Key | Default Option                                    | Valid Options                                | Command Line Override             | Configuration API                       | Description                                                                                                                                                                       |
| ------------------------ | ------------------------------------------------- | -------------------------------------------- | --------------------------------- | --------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| `templateFormats`        | `liquid,ejs, md,hbs, mustache,haml, pug,njk,html` | _Any combination of these_                   | `--formats`                       | `setTemplateFormats` (New in `v0.2.14`) | Specify which type of templates should be transformed.                                                                                                                            |
...
| `filters`                | `{}`                                              | `Object`                                     | N/A                               | `addTransform`                          | Filters can transform output on a template. Take the format `function(str, outputPath) { return str; }`. For example, use a filter to format an HTML file with proper whitespace. |
