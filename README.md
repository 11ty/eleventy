...
| `pathPrefix`             | `/`                                               | _A prefix directory added to links_          | `--pathprefix`        | Used by the url filter and inserted at the beginning of all href links. Use if your blog lives in a subdirectory on your web server.                                              |
