...
| `passthroughFileCopy`    | `false`                                           | `true` or `false`                            | N/A                   | Files found (that aren’t templates) from white-listed file extensions will pass-through to the output directory. [Read more about Pass-through Copy](docs/copy.md).               |
