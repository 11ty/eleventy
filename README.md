...
| `templateFormats`        | `liquid,ejs, md,hbs, mustache,haml, pug,njk,html` | _Any combination of these_                   | `--formats`                       | Specify which type of templates should be transformed. Also available with `setTemplateFormats` on the Configuration API (New in `v0.2.14`)                                                                                                                                                                                                 |
