...
test("Eleventy data schema (fails, using zod) #879", async (t) => {
  ...
  t.is(e.originalError.toString(), 'Validation error: Invalid input: expected boolean, received number at "draft" or Invalid input: expected undefined, received number at "draft"');
});
