...
test("JavaScript template type (function)", async (t) => {
  let tmpl = await getNewTemplate("./test/stubs/function.11ty.js", "./test/stubs/", "./dist");
...
test("JavaScript template type (class with data getter)", async (t) => {
  let tmpl = await getNewTemplate("./test/stubs/class-data.11ty.js", "./test/stubs/", "./dist");
...
test("JavaScript template type (class with data method)", async (t) => {
  let tmpl = await getNewTemplate("./test/stubs/class-data-fn.11ty.js", "./test/stubs/", "./dist");
...
test("JavaScript template type (should use the same class instance for data and render)", async (t) => {
  let tmpl = await getNewTemplate("./test/stubs/oneinstance.11ty.js", "./test/stubs/", "./dist");
...
test("JavaScript template type (object)", async (t) => {
  let tmpl = await getNewTemplate("./test/stubs/object.11ty.js", "./test/stubs/", "./dist");
...
test("JavaScript template type (class, no render method)", async (t) => {
  let tmpl = await getNewTemplate("./test/stubs/class-norender.11ty.js", "./test/stubs/", "./dist");
