...
test("Layouts", (t) => {
  ...
  t.false(
    map.isFileRelevantTo("_includes/layout.njk", "_includes/include.njk")
  );
  t.false(
    map.isFileRelevantTo("_includes/include.njk", "_includes/layout.njk")
  );
  ...
  t.false(
    map.isFileRelevantTo("_includes/layout.njk", "_includes/include.njk", false)
  );
  t.false(
    map.isFileRelevantTo("_includes/include.njk", "_includes/layout.njk", false)
  );
});
